...
const is_live = config.SSL_IS_LIVE; // sandbox er jonno false thakbe





// STEP 1: SSLCommerz e payment session shuru koro
// order object ta database e already create kora "pending" order
...
const data ={total_amount:order.totalAmount,
currency:"BDT",
